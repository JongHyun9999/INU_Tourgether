...
import 'package:TourGather/models/message_model.dart';
...
class _MessageScreenState extends State<MessageScreen> {
  ...
  final Map<String, double> user_gps = {'x': 1, 'y': 2};
  ...
  Future getMessageList() async {
    Map<String, dynamic> postData = {'user_gps_x': 31, 'user_gps_y': 126.3};
